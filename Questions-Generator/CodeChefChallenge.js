...
(async()=>{
	...
	let link = 'https://www.codechef.com/problems/challenge?sort_by=Accuracy&sorting_order=desc';
	...
	fs.writeFileSync('./CodeChefChallenge.json', JSON.stringify(data, null, '\t') ,'utf-8');
	await browser.close();
})();
