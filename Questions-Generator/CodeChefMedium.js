...
(async()=>{
	...
	let link = 'https://www.codechef.com/problems/medium?sort_by=Accuracy&sorting_order=desc';
	...
	fs.writeFileSync('./CodeChefMedium.json', JSON.stringify(data, null, '\t') ,'utf-8');
	await browser.close();
})();
