...
(async()=>{
	...
	let link = 'https://www.codechef.com/problems/school?sort_by=Accuracy&sorting_order=desc';
	...
	fs.writeFileSync('./CodeChefSchool.json', JSON.stringify(data, null, '\t') ,'utf-8');
	//console.log(data);
	await browser.close();
})();
